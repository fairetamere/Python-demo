...
from setting import REDIS_HOST,REDIS_PORT,REDIS_PASSWORD,REDIS_KEY,REDIS_DB,PROXY_SCORE_MAX,PROXY_SCORE_MIN,\
    PROXY_SCORE_INIT
...
class RedisClient(object):
    ...
    def exists(self, proxy: Proxy) -> bool:
        ...
        """
        return not self.db.zscore(REDIS_KEY, proxy.string()) is None#查询ip是否存在
    ...
    def max(self, proxy: Proxy) -> int:
        ...
        return self.db.zadd(REDIS_KEY, {proxy.string(): PROXY_SCORE_MAX})#如果ip可用，则立即设置为最大分数
    ...
    def count(self) -> int:
        ...
        :return: count, int
        """
        return self.db.zcard(REDIS_KEY)#查询ip数量
    ...
    def all(self) -> List[Proxy]:
        ...
        """
        return convert_proxy_or_proxies(self.db.zrangebyscore(REDIS_KEY, PROXY_SCORE_MIN, PROXY_SCORE_MAX))#返回所有ip
